...
// Utilizo un bucle para desestructurar mis objetos y conseguir el id y el precio. (De todas formas no lo aplico dentro de mi simulador.)
for (equipo of equipos){
    const { id, precio } = equipo
    
    consologuear( "id producto: "+ id)
    consologuear( "Precio x jornada: $ "+ precio + "ARS")
